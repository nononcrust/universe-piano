  ...
  return (
    <section className="flex flex-col pt-32">
      <div className="container flex flex-col">
        ...
        <h1 className="text-2xl font-bold">조작 없는 후기</h1>
        <h2 className="mt-2 text-muted-foreground">유니버스 크루들의 후기를 확인 해보세요.</h2>
      </div>
...
const ReviewItem = ({ name, label, content, span }: ReviewItemProps) => {
  return (
    <div
      className={cn(
