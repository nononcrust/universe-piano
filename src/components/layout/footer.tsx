  ...
  return (
    <div className="mt-4 flex gap-2">
      <Link
        ...
        target="_blank"
        className="hover:bg-content-light0 flex h-8 w-8 items-center justify-center rounded-full bg-slate-400 transition"
      >
        <Image
      ...
      <Link
        ...
        target="_blank"
        className="hover:bg-content-light0 flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-slate-400 transition"
      >
        <Image
