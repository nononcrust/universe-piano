...
export default function AboutCompanyPage() {
  return (
    <main>
      ...
      <Aos>
        <section className="container py-32">
          ...
          <div className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="bg-content h-[240px] rounded-2xl"></div>
            <div className="bg-content h-[240px] rounded-2xl"></div>
            <div className="bg-content h-[240px] rounded-2xl"></div>
          </div>
        </section>
      ...
      <section
        className="bg-content flex h-[320px] flex-1 justify-center bg-cover bg-center bg-no-repeat md:justify-start"
        style={{
