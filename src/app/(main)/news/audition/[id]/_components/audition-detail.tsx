...
import { CommentInput } from "@/app/(main)/news/audition/[id]/_components/comment-input";
...
import { AuditionCommentItem } from "./audition-comment-item";
...
export const AuditionDetail = () => {
  ...
  if (!audition) return redirect(ROUTE.NEWS.AUDITION.LIST);
