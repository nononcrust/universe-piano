...
export default function AboutPage() {
  return (
    <main className="flex-col">
      ...
      />
      <Tabs className="container p-0 md:px-4" defaultValue="visitors">
        <TabsList className="h-14 border-b">
          <TabsTrigger value="visitors">처음 오신 분들께</TabsTrigger>
          <TabsTrigger value="greetings">대표의 인삿말</TabsTrigger>
        </TabsList>
        <TabsContent className="px-4" value="visitors">
          <h1 className="mt-8 text-xl font-semibold">처음 오신 분들께 드리는 메시지</h1>
          <p className="mt-4 text-muted-foreground">
            유니버스 피아노는 모든 고객에게 최고의 컨설팅을 제공해드리기 위해 어쩌구
          </p>
        </TabsContent>
        <TabsContent className="px-4" value="greetings">
